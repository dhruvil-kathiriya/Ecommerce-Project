...
routs.post("/insert_admin", Admin.uploadAdminImage, adminController.insert_admin)
...
routs.post("/checklogin", passport.authenticate('local', { failureRedirect: "/admin/" }), adminController.checklogin);
